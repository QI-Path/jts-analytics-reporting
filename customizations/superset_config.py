...
APP_NAME = "QI Path Analytics and Reporting"
APP_ICON = "/static/assets/customizations/images/qi-path-logo.png"
FAVICONS = [{"href": "/static/assets/customizations/images/favicon.png"}]
LOGO_TOOLTIP = "QI Path: Analytics and Reporting"
LOGO_TARGET_PATH = "/"
